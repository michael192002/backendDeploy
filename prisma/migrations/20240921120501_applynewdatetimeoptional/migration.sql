...
INSERT INTO "new_Employee" ("cafeId", "email_address", "gender", "id", "name", "phone_number", "start") SELECT "cafeId", "email_address", "gender", "id", "name", "phone_number", "start" FROM "Employee";
DROP TABLE "Employee";
